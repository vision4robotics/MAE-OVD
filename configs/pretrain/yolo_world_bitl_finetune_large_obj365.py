...
# YOLO-World-v2-l backbone with full Objects365 dataset training
#
# Usage:
...
#     --config configs/pretrain/yolo_world_bitl_finetune_large_obj365.py \
#     --max-samples 500000 --launcher pytorch
...
max_samples = 500000           # Large Object365 dataset
val_interval = 5
log_interval = 50
...
# ====================================================================
# Data - Full Objects365 dataset (Update paths according to your environment)
# ====================================================================
data_root = "datasets/objects365"  # Relative path, update to your data location
ann_file = "train/butian_obj_train_v1only.json"
data_prefix = dict(img="train/")

# Validation set
val_ann_file = "val/butian_obj_val.json"
...
# Checkpoint
# ====================================================================
work_dir = "work_dirs/pretrain/yolo_world_bitl_l_obj365"
load_from = None
resume = False
